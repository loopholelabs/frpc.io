    ...
    if (show) {
        return (
            <div className={"bg-code-background rounded-lg wrapper-code"}>
                <div className={`h-12 w-full bg-code-bar-background rounded-t-lg flex justify-between`}>
    ...
    return (
        <div className={"relative"}>
            <Transition
                ...
                leaveTo="opacity-0"
            >
                <button onClick={copy} className={"absolute top-3.5 right-0 h-5 w-5 text-text-dark opacity-70 hover:opacity-100"}>
                    <DuplicateIcon/>
                </button>
            </Transition>
            <Transition
                ...
                leaveTo="opacity-0"
            >
                <button className={"absolute top-3.5 right-0 h-5 w-5 text-text-dark opacity-70 hover:opacity-100"}>
                    <CheckIcon/>
                </button>
            </Transition>
        </div>
