...
Moreover, Frisbee is a **drop-in replacement for GRPC** thanks to our generated interfaces matching GRPC's.

In an apples-to-apples comparison, [Frisbee RPC blows GRPC's performance out of the water](.)
