...
```nix
$ mkdir -p ~/frpc-examples/echo
$ cd ~/frpc-examples/echo
```
...
And with that you should be ready. Let's run the following command to generate the server and client code:
