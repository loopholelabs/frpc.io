...
<Note content="test FRPC works with Go version 1.17 or later. For installation instructions see FRPC works with `Go` version 1.17 or later. For installation instructions see FRPC works with `Go` version 1.17 or later. For installation instructions see" />
