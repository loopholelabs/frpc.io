function propmaker(allDocs, config, params) {
    ...
    if (params) {
        ...
        if (requiredDoc && requiredDoc.headings) {
            currentDoc = {
    ...
    return {
        props: {
            ...
            currentVersion: (params && params.version) ? params.version : config.defaultVersion,
            currentSection: (params && params.section) ? params.section : "",
            currentSlug: (params && params.slug) ? params.slug : "",
